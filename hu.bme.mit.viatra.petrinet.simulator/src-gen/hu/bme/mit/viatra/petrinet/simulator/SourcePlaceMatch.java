...
/**
 * Pattern-specific match representation of the hu.bme.mit.viatra.petrinet.simulator.sourcePlace pattern,
 * to be used in conjunction with {@link SourcePlaceMatcher}.
 * 
...
public abstract class SourcePlaceMatch extends BasePatternMatch {
  ...
  private SourcePlaceMatch(final Transition pT, final Place pPl) {
    this.fT = pT;
    this.fPl = pPl;
  }
  ...
  public List<String> parameterNames() {
    return SourcePlaceMatch.parameterNames;
  }
  ...
  @Override
  public SourcePlaceMatch toImmutable() {
  ...
  public boolean equals(final Object obj) {
    if (this == obj)
    	return true;
    if (!(obj instanceof SourcePlaceMatch)) { // this should be infrequent
    	if (obj == null) {
    		return false;
    	}
    ...
    SourcePlaceMatch other = (SourcePlaceMatch) obj;
  ...
  @Override
  public SourcePlaceQuerySpecification specification() {
    try {
   ...
   * 
   */
  public static SourcePlaceMatch newEmptyMatch() {
   ...
   * 
   */
  public static SourcePlaceMatch newMutableMatch(final Transition pT, final Place pPl) {
   ...
   * 
   */
  public static SourcePlaceMatch newMatch(final Transition pT, final Place pPl) {
    return new Immutable(pT, pPl);
  }
  
  private static final class Mutable extends SourcePlaceMatch {
  ...
  private static final class Immutable extends SourcePlaceMatch {
