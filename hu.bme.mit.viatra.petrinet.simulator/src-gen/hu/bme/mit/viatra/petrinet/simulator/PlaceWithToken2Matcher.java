...
public class PlaceWithToken2Matcher extends BaseMatcher<PlaceWithToken2Match> {
   ...
   */
  @Deprecated
  public DeltaMonitor<PlaceWithToken2Match> newFilteredDeltaMonitor(final boolean fillAtStart, final Place pPl) {
    return rawNewFilteredDeltaMonitor(fillAtStart, new Object[]{pPl});
  }
