...
public class PlaceWithTokenMatcher extends BaseMatcher<PlaceWithTokenMatch> {
   ...
   */
  @Deprecated
  public DeltaMonitor<PlaceWithTokenMatch> newFilteredDeltaMonitor(final boolean fillAtStart, final Place pPl, final Token pTo) {
    return rawNewFilteredDeltaMonitor(fillAtStart, new Object[]{pPl, pTo});
  }
