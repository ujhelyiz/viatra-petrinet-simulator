 ...
 * <ul>
 *   <li>{@link hu.bme.mit.viatra.petrinet.model.petrinet.Transition#getNet <em>Net</em>}</li>
 *   <li>{@link hu.bme.mit.viatra.petrinet.model.petrinet.Transition#getInArcs <em>In Arcs</em>}</li>
 *   <li>{@link hu.bme.mit.viatra.petrinet.model.petrinet.Transition#getOutArcs <em>Out Arcs</em>}</li>
 * </ul>
 * </p>
 *
 * @see hu.bme.mit.viatra.petrinet.model.petrinet.PetriNetPackage#getTransition()
 * @model
 * @generated
 */
public interface Transition extends NamedElement {
     ...
     * It is bidirectional and its opposite is '{@link hu.bme.mit.viatra.petrinet.model.petrinet.PetriNet#getTransitions <em>Transitions</em>}'.
     * <!-- begin-user-doc -->
     * <p>
     ...
     * @see #setNet(PetriNet)
     * @see hu.bme.mit.viatra.petrinet.model.petrinet.PetriNetPackage#getTransition_Net()
    ...
    /**
     * Sets the value of the '{@link hu.bme.mit.viatra.petrinet.model.petrinet.Transition#getNet <em>Net</em>}' container reference.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     ...
     * It is bidirectional and its opposite is '{@link hu.bme.mit.viatra.petrinet.model.petrinet.PTArc#getTarget <em>Target</em>}'.
     * <!-- begin-user-doc -->
     * <p>
     ...
     * @see hu.bme.mit.viatra.petrinet.model.petrinet.PetriNetPackage#getTransition_InArcs()
     ...
     * It is bidirectional and its opposite is '{@link hu.bme.mit.viatra.petrinet.model.petrinet.TPArc#getSource <em>Source</em>}'.
     * <!-- begin-user-doc -->
     * <p>
     ...
     * @see hu.bme.mit.viatra.petrinet.model.petrinet.PetriNetPackage#getTransition_OutArcs()
