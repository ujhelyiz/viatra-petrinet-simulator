...
/**
 * This is the item provider adapter for a {@link hu.bme.mit.viatra.petrinet.model.petrinet.Place} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class PlaceItemProvider extends NamedElementItemProvider {
        ...
        itemPropertyDescriptors.add
            (createItemPropertyDescriptor
                (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
                 getResourceLocator(),
                 getString("_UI_Place_net_feature"),
                 getString("_UI_PropertyDescriptor_description", "_UI_Place_net_feature", "_UI_Place_type"),
                 PetriNetPackage.Literals.PLACE__NET,
                 true,
                 false,
                 true,
                 null,
        ...
        itemPropertyDescriptors.add
            (createItemPropertyDescriptor
                (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
                 ...
                 PetriNetPackage.Literals.PLACE__IN_ARCS,
                 true,
                 false,
                 true,
                 null,
    ...
    public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
        if (childrenFeatures == null) {
            ...
            childrenFeatures.add(PetriNetPackage.Literals.PLACE__OUT_ARCS);
    ...
    protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
        ...
        newChildDescriptors.add
            (createChildParameter
                (PetriNetPackage.Literals.PLACE__OUT_ARCS,
                 PetriNetFactory.eINSTANCE.createPTArc()));
